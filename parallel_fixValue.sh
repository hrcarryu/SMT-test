#!/bin/bash
# ./parallel_fixValue.sh 100
# ./parallel.sh 100 Model-Validation

# 定义输入目录和输出目录
input_directory="/home/hanrui/QF_NIA"
output_directory="/home/hanrui/QF_NIA_res"
path_directory="QF_NIA_path_res"
...
for group_file in "${path_directory}/group_"*; do
    ...
    ./run_fixValue.sh "$group_file" "$output_directory" "$input_directory" "$path_directory/isEqual" > "${path_directory}/isEqual/${group_name}.txt" 2>&1 &
done
